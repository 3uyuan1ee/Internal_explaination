"""
CUB-200-2011 dataset loader for CBM V2.
...
def select_50_classes() -> dict:
    ...
    return {cid: idx for idx, cid in enumerate(selected)}
...
def get_dataloaders(batch_size: int = 32, num_workers: int = 2):
    ...
    selected_classes = select_50_classes()
    cfg.SELECTED_CLASSES = selected_classes
